...
function add_theme_scripts(){
	...
	wp_enqueue_script('fontawesome-all',	plugins_url().'/fewo-manager/js/fontawesome-all.min.js');
	wp_enqueue_script('popper', 			plugins_url()."/fewo-manager/js/popper.min.js");
	wp_enqueue_script('bootstrap4', 		plugins_url()."/fewo-manager/js/bootstrap4.min.js");
	wp_enqueue_script('jssor', 				plugins_url()."/fewo-manager/js/jssor.slider-26.1.5.min.js");
	wp_enqueue_script('slider', 			plugins_url()."/fewo-manager/js/slider.min.js");
	
	wp_enqueue_style('bootstrap4-css', 	plugins_url()."/fewo-manager/css/bootstrap4.min.css");
	wp_enqueue_style('slider-css', 		plugins_url()."/fewo-manager/css/slider.min.css");
	wp_enqueue_style('fewo-css', 		plugins_url()."/fewo-manager/css/fewo.css");
}
...
function fewo_shortcodes($atts){
	...
	if(isset($atts) && $atts !== empty($atts)){
		...
		return Timber::compile("wohnung-frontend.html.twig",$context);
	}
...
function preis_shortcodes($atts){
	...
	if(isset($atts) && $atts !== empty($atts)){
		...
		return Timber::compile("preistabelle-frontend.html.twig",$context);
	}
}
/**
 * =============================
